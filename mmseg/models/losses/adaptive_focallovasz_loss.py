...
def lovasz_softmax_flat(probs, labels, gamma=2.0, classes='present', class_weight=None):
...
class AdaptiveFocalLovaszLoss(nn.Module):
    """LovaszLoss.
    ...
    def __init__(self,
                 ...
                 gamma=2.0,
                 loss_name='loss_afl'):
        super(AdaptiveFocalLovaszLoss, self).__init__()
